...
def create_train_model(hidden_nodes1,hidden_nodes2, num_iters,num_samples):
    ...
    print("loss (hidden nodes: %d-%d, iterations: %d): %.2f" % (hidden_nodes1,hidden_nodes2, num_iters, loss_plot[hidden_nodes][-1]))
    sess.close()
...
if __name__=="__main__":
    ...
    weights3 = {5: None, 10: None, 20: None, 40:None}  
    num_iters = 50
    hidden_nodes1=20
    for hidden_nodes in num_hidden_nodes:  
        weights1[hidden_nodes], weights2[hidden_nodes],weights3[hidden_nodes] = create_train_model(hidden_nodes1,hidden_nodes, num_iters,split)
        print(hidden_nodes)
    ...
    for hidden_nodes in num_hidden_nodes:
        ...
        with tf.Session() as sess:
            ...
            print('Network architecture 16-%d-%d-2 accuracy: %.2f%%' % (hidden_nodes1,hidden_nodes, accuracy))
